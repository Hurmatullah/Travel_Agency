...
$test=("SELECT user_id,first_name,last_name,email_address,phone_number,username,password from admin");
...
<table class='table table-hover'><tr><th>ID:</th><th>Firstname:</th><th>Lastname:</th><th>Email:<th>Phone:</th><th>Username:</th>
<th>Password:</th><th>Delete:</th><th>Edit:</th><th>Add:</th>

</tr>";
do{
	
	echo "<tr class='success'>";
	echo "<td class='success'>".$name['user_id']."</td>";
	...
	echo "<td>"."<a href='admin_delete.php?id=".$name['user_id']."'><img  style='margin-left:30%;' src='icon/delete.png' width='16' height='16' />"."</a>"."</td>";
	
	echo "<td>"."<a href='admin_edit.php?id=".$name['user_id']."'><img src='icon/edit.png'  style='margin-left:30%;' width='16' height='16' />"."</a>"."</td>";
	echo "<td>"."<a href='admin_add.php'><img src='icon/add.png' width='16' height='16' style='margin-left:30%;' />"."</a>"."</td>";
