...
$test=("SELECT * from travel_agency");
...
<head>
		...
		<title>TRAVEL AGENCIES DESCRIPTION</title>
		<meta charset="utf-8">
...
<div class='container'>
<div class='row'>
<div class='col-md-12'><center><h1 class='alert alert-success' style='margin-top:2%'>Welcome To Team Information Page</h1></center>
</div>
</div></div>
...
<table class='table table-hover'><tr><th>ID:</th><th>Name:</th><th>Address:</th><th>Phone:</th><th>Contract Customer ID:</th>
...
do{
	...
	echo "<td class='success'>".$name['t_id']."</td>";
	echo "<td>".$name['name']."</td>";
	echo "<td>".$name['address']."</td>";
	echo "<td>".$name['phone']."</td>";
	
		echo "<td>".$name['contract_customer_id']."</td>";
	echo "<td>"."<a href='team_delete.php?id=".$name['t_id']."'><img  style='margin-left:30%;' src='icon/delete.png' width='16' height='16' />"."</a>"."</td>";
	
	echo "<td>"."<a href='team_edit.php?id=".$name['t_id']."'><img src='icon/edit.png'  style='margin-left:30%;' width='16' height='16' />"."</a>"."</td>";
	echo "<td>"."<a href='team_add.php'><img src='icon/add.png' width='16' height='16' style='margin-left:30%;' />"."</a>"."</td>";
